...
from eval_scripts.eval_FN import eval_FN
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    for eval_len in eval_len_list:
        x_len = args.x_len
        eval_FN(operator, args, args.noisy_scale, x_len = eval_len, calculate_l2 = True, output_path = output_path)
        eval_FN(operator, args, 0, x_len = eval_len, calculate_l2 = True, output_path = output_path)
    if args.eval_LE:
